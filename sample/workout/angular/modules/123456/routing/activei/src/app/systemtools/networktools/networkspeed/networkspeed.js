...
checkUploadSpeed( 30, function ( speed, average ) {
    ...
    function initialise()
    {
      ...
      var seed =0;
    var incre =0;
    var margin,x,y,line,svg,g,graph,xAxis,axis,path1, path2 ;
    ...
    function updateData(a,speedVal)
    {
        ...
        if (parseFloat(speedVal) <= 10 ) {
            seed=1;
            incre=10;
        }
        else if ((parseFloat(speedVal) > 10) && (parseFloat(speedVal) <= 100)) {
             seed=10;
            incre=100;
        }
        else if ((parseFloat(speedVal) > 100) && (parseFloat(speedVal) <= 1000)) {
             seed=100;
            incre=1000;
        }
    ...
    svg = d3.select(".networkSpeed").append("svg")
