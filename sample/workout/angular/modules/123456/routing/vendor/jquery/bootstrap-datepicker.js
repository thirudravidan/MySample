...
DPGlobal.modes[this.viewMode].navStep * (target[0].className == 'glyphicon glyphicon-chevron-left' ? -1 : 1)
);
this.fill();
break;
}
...
headTemplate: '<thead>'+
'<tr>'+
'<th class="glyphicon glyphicon-chevron-left"></th>' +
'<th colspan="5" class="switch"></th>'+
////Modified by 
// '<th class="glyphicon glyphicon-chevron-right"><i class="icon-arrow-right"/></th>' +
'<th class="glyphicon glyphicon-chevron-right"></th>' +
'</tr>'+
'</thead>',
